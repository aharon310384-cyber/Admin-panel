...
export default function NewCustomerForm({ countries, action, returnTo }: Props) {
      ...
      <div className="card">
        ...
        <div className="field-grid">
          ...
          <div className="field">
            ...
            <input type="text" name="middleName" className="field-input" />
          </div>
          ...
          <div className="field">
            ...
            <input type="text" name="username" className="field-input" placeholder="@username" />
          </div>

          <div className="field">
            <label className="field-label">Телефон</label>
            <input type="tel" name="phone" className="field-input" placeholder="+7 (999) 000-00-00" />
          </div>
          ...
          <div className="field">
            ...
            <input type="text" name="city" className="field-input" placeholder="Мадрид" />
          </div>
          ...
          <div className="field">
            ...
            <input
              ...
              className="field-input"
              placeholder="2026.06.xx"
            />
          </div>

          <div className="field field--full">
            <label className="field-label">Адрес</label>
            <textarea name="address" className="field-input field-textarea" rows={3} />
          </div>
        </div>
      </div>

      <div className="form-actions">
        <Link href={returnTo ?? "/recipients"} className="btn-secondary">
          Отмена
        </Link>
