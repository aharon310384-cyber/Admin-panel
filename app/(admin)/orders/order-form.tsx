    ...
    <form onSubmit={handleSubmit} className="order-form">
      <div className="card">
        ...
        <div className="field">
          ...
          <select name="customerId" className={`field-input ${error.customerId ? "field-input--error" : ""}`}>
      ...
      <div className="card">
        <div className="section-header">
          <h2 className="section-title">Услуги и позиции</h2>
          ...
          {items.map((item, idx) => (
            <div key={idx} className="item-row">
              <div className="item-product">
                <label className="field-label">Услуга / позиция</label>
                <select
      ...
      <div className="form-actions">
        <Link href="/orders" className="btn-secondary">Отмена</Link>
